...
public class ListPokemoon {
    ...
    private static ArrayList<Pouvoir> m_pouvPokeAvailable = new ArrayList<Pouvoir>(Arrays.asList(new PouvEther(), new PouvPlomb(), new PouvFerveurGuerrière(), new PouvKamikaz(), new PouvResistance(), new PouvUsurpation(), new PouvSoinSimple(), new PouvSoinTotal(), new PouvSoinZone()));
